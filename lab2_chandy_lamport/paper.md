...
permission.
0 1985 ACM 0734-2071/85/0200-0063 $00.
...
```
```
global ------ state: token in C’ global state: ---_ token in q
```
### L---------l L-------J
...
ej-2, ej, ej-1.
Let seq* be a permutation of seq that is identical to seq except that ej and ej-
